...
export abstract class IApiService {
    ...
    abstract newIngredientDummy(name: string): void;
    abstract getAllRecipes$(): Observable<Recipe[]>;
    abstract getAllCachedRecipes$(): Observable<Recipe[]>;
    abstract getAllCachedIngredients$(): Observable<Ingredient[]>;
    abstract getIngredients$(filter: IngredientFilter): Observable<Ingredient[]>;
    abstract createIngredient(ingredient: Ingredient): boolean;
    abstract deleteIngredient(ingredient: Ingredient): Observable<boolean>;
    abstract updateIngredient(ingredient: Ingredient): boolean;
    ...
    abstract getIngredientChangedSubject(): Subject<null>;
